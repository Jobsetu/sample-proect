import {
  ...
  toUint8Array,
  toUtf8
} from "./chunk-MESFTL3R.js";
import {
  __awaiter,
  __generator,
  __values
} from "./chunk-WLK3NC7Z.js";
import {
  __publicField
  ...
  return (next, context) => async (args) => {
    ...
    try {
      ...
      if (clientConfig.followRegionRedirects) {
        const statusCode = (_a2 = err == null ? void 0 : err.$metadata) == null ? void 0 : _a2.httpStatusCode;
...
var de_CopyObjectCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.CopyObjectResult = de_CopyObjectResult(data2, context);
  return contents;
};
...
var de_CreateMultipartUploadCommand = async (output, context) => {
  ...
  if (data2[_UI] != null) {
    contents[_UI] = expectString(data2[_UI]);
  }
  return contents;
};
var de_CreateSessionCommand = async (output, context) => {
  ...
  const data2 = expectNonNull(expectObject(await parseXmlBody(output.body, context)), "body");
  if (data2[_C] != null) {
    contents[_C] = de_SessionCredentials(data2[_C], context);
  }
  return contents;
};
...
var de_DeleteObjectsCommand = async (output, context) => {
  ...
  if (data2.Deleted === "") {
    ...
    contents[_De] = de_DeletedObjects(getArrayIfSingleItem(data2[_De]), context);
  }
  if (data2.Error === "") {
    contents[_Err] = [];
  } else if (data2[_Er] != null) {
    contents[_Err] = de_Errors(getArrayIfSingleItem(data2[_Er]), context);
  }
  return contents;
};
...
var de_GetBucketAccelerateConfigurationCommand = async (output, context) => {
  ...
  const data2 = expectNonNull(expectObject(await parseXmlBody(output.body, context)), "body");
  if (data2[_S] != null) {
    contents[_S] = expectString(data2[_S]);
  }
  return contents;
};
var de_GetBucketAclCommand = async (output, context) => {
  ...
  const data2 = expectNonNull(expectObject(await parseXmlBody(output.body, context)), "body");
  if (data2.AccessControlList === "") {
    contents[_Gr] = [];
  } else if (data2[_ACLc] != null && data2[_ACLc][_G] != null) {
    contents[_Gr] = de_Grants(getArrayIfSingleItem(data2[_ACLc][_G]), context);
  }
  if (data2[_O] != null) {
    contents[_O] = de_Owner(data2[_O], context);
  }
  return contents;
};
var de_GetBucketAnalyticsConfigurationCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.AnalyticsConfiguration = de_AnalyticsConfiguration(data2, context);
  return contents;
};
var de_GetBucketCorsCommand = async (output, context) => {
  ...
  if (data2.CORSRule === "") {
    ...
    contents[_CORSRu] = de_CORSRules(getArrayIfSingleItem(data2[_CORSR]), context);
  }
  return contents;
};
var de_GetBucketEncryptionCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.ServerSideEncryptionConfiguration = de_ServerSideEncryptionConfiguration(data2, context);
  return contents;
};
var de_GetBucketIntelligentTieringConfigurationCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.IntelligentTieringConfiguration = de_IntelligentTieringConfiguration(data2, context);
  return contents;
};
var de_GetBucketInventoryConfigurationCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.InventoryConfiguration = de_InventoryConfiguration(data2, context);
  return contents;
};
var de_GetBucketLifecycleConfigurationCommand = async (output, context) => {
  ...
  if (data2.Rule === "") {
    ...
    contents[_Rul] = de_LifecycleRules(getArrayIfSingleItem(data2[_Ru]), context);
  }
  return contents;
};
...
var de_GetBucketLoggingCommand = async (output, context) => {
  ...
  const data2 = expectNonNull(expectObject(await parseXmlBody(output.body, context)), "body");
  if (data2[_LE] != null) {
    contents[_LE] = de_LoggingEnabled(data2[_LE], context);
  }
  return contents;
};
var de_GetBucketMetadataConfigurationCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.GetBucketMetadataConfigurationResult = de_GetBucketMetadataConfigurationResult(data2, context);
  return contents;
};
var de_GetBucketMetadataTableConfigurationCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.GetBucketMetadataTableConfigurationResult = de_GetBucketMetadataTableConfigurationResult(data2, context);
  return contents;
};
var de_GetBucketMetricsConfigurationCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.MetricsConfiguration = de_MetricsConfiguration(data2, context);
  return contents;
};
var de_GetBucketNotificationConfigurationCommand = async (output, context) => {
  ...
  const data2 = expectNonNull(expectObject(await parseXmlBody(output.body, context)), "body");
  if (data2[_EBC] != null) {
    contents[_EBC] = de_EventBridgeConfiguration(data2[_EBC], context);
  }
  if (data2.CloudFunctionConfiguration === "") {
    contents[_LFC] = [];
  } else if (data2[_CFC] != null) {
    contents[_LFC] = de_LambdaFunctionConfigurationList(getArrayIfSingleItem(data2[_CFC]), context);
  }
  if (data2.QueueConfiguration === "") {
    contents[_QCu] = [];
  } else if (data2[_QC] != null) {
    contents[_QCu] = de_QueueConfigurationList(getArrayIfSingleItem(data2[_QC]), context);
  }
  if (data2.TopicConfiguration === "") {
    contents[_TCop] = [];
  } else if (data2[_TCo] != null) {
    contents[_TCop] = de_TopicConfigurationList(getArrayIfSingleItem(data2[_TCo]), context);
  }
  return contents;
};
var de_GetBucketOwnershipControlsCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.OwnershipControls = de_OwnershipControls(data2, context);
  return contents;
};
var de_GetBucketPolicyCommand = async (output, context) => {
  ...
  contents.Policy = expectString(data2);
  return contents;
};
var de_GetBucketPolicyStatusCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.PolicyStatus = de_PolicyStatus(data2, context);
  return contents;
};
var de_GetBucketReplicationCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.ReplicationConfiguration = de_ReplicationConfiguration(data2, context);
  return contents;
};
var de_GetBucketRequestPaymentCommand = async (output, context) => {
  ...
  const data2 = expectNonNull(expectObject(await parseXmlBody(output.body, context)), "body");
  if (data2[_Pa] != null) {
    contents[_Pa] = expectString(data2[_Pa]);
  }
  return contents;
};
var de_GetBucketTaggingCommand = async (output, context) => {
  ...
  if (data2.TagSet === "") {
    ...
    contents[_TS] = de_TagSet(getArrayIfSingleItem(data2[_TS][_Ta]), context);
  }
  return contents;
};
var de_GetBucketVersioningCommand = async (output, context) => {
  ...
  const data2 = expectNonNull(expectObject(await parseXmlBody(output.body, context)), "body");
  if (data2[_MDf] != null) {
    contents[_MFAD] = expectString(data2[_MDf]);
  }
  if (data2[_S] != null) {
    contents[_S] = expectString(data2[_S]);
  }
...
var de_GetBucketWebsiteCommand = async (output, context) => {
  ...
  const data2 = expectNonNull(expectObject(await parseXmlBody(output.body, context)), "body");
  if (data2[_ED] != null) {
    contents[_ED] = de_ErrorDocument(data2[_ED], context);
  }
  if (data2[_ID] != null) {
    contents[_ID] = de_IndexDocument(data2[_ID], context);
  }
  if (data2[_RART] != null) {
    contents[_RART] = de_RedirectAllRequestsTo(data2[_RART], context);
  }
  if (data2.RoutingRules === "") {
    contents[_RRo] = [];
  } else if (data2[_RRo] != null && data2[_RRo][_RRou] != null) {
    contents[_RRo] = de_RoutingRules(getArrayIfSingleItem(data2[_RRo][_RRou]), context);
  }
  return contents;
};
...
var de_GetObjectAttributesCommand = async (output, context) => {
  ...
  const data2 = expectNonNull(expectObject(await parseXmlBody(output.body, context)), "body");
  if (data2[_Ch] != null) {
    contents[_Ch] = de_Checksum(data2[_Ch], context);
  }
  if (data2[_ETa] != null) {
    contents[_ETa] = expectString(data2[_ETa]);
  }
  if (data2[_OP] != null) {
    contents[_OP] = de_GetObjectAttributesParts(data2[_OP], context);
  }
  if (data2[_OSb] != null) {
    contents[_OSb] = strictParseLong(data2[_OSb]);
  }
  if (data2[_SC] != null) {
...
var de_GetObjectLegalHoldCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.LegalHold = de_ObjectLockLegalHold(data2, context);
  return contents;
};
var de_GetObjectLockConfigurationCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.ObjectLockConfiguration = de_ObjectLockConfiguration(data2, context);
  return contents;
};
var de_GetObjectRetentionCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.Retention = de_ObjectLockRetention(data2, context);
  return contents;
};
...
var de_GetPublicAccessBlockCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.PublicAccessBlockConfiguration = de_PublicAccessBlockConfiguration(data2, context);
  return contents;
};
...
var de_ListBucketAnalyticsConfigurationsCommand = async (output, context) => {
  ...
  const data2 = expectNonNull(expectObject(await parseXmlBody(output.body, context)), "body");
  if (data2.AnalyticsConfiguration === "") {
    contents[_ACLn] = [];
  } else if (data2[_AC] != null) {
    contents[_ACLn] = de_AnalyticsConfigurationList(getArrayIfSingleItem(data2[_AC]), context);
  }
  if (data2[_CTon] != null) {
...
var de_ListBucketIntelligentTieringConfigurationsCommand = async (output, context) => {
  ...
  if (data2.IntelligentTieringConfiguration === "") {
    contents[_ITCL] = [];
  } else if (data2[_ITC] != null) {
    contents[_ITCL] = de_IntelligentTieringConfigurationList(getArrayIfSingleItem(data2[_ITC]), context);
  }
  if (data2[_IT] != null) {
    contents[_IT] = parseBoolean(data2[_IT]);
  }
...
var de_ListBucketInventoryConfigurationsCommand = async (output, context) => {
  ...
  if (data2.InventoryConfiguration === "") {
    contents[_ICL] = [];
  } else if (data2[_IC] != null) {
    contents[_ICL] = de_InventoryConfigurationList(getArrayIfSingleItem(data2[_IC]), context);
  }
  if (data2[_IT] != null) {
    contents[_IT] = parseBoolean(data2[_IT]);
  }
...
var de_ListBucketMetricsConfigurationsCommand = async (output, context) => {
  ...
  if (data2.MetricsConfiguration === "") {
    contents[_MCL] = [];
  } else if (data2[_MC] != null) {
    contents[_MCL] = de_MetricsConfigurationList(getArrayIfSingleItem(data2[_MC]), context);
  }
  if (data2[_NCT] != null) {
    contents[_NCT] = expectString(data2[_NCT]);
  }
...
var de_ListBucketsCommand = async (output, context) => {
  ...
  if (data2.Buckets === "") {
    ...
    contents[_Bu] = de_Buckets(getArrayIfSingleItem(data2[_Bu][_B]), context);
  }
  if (data2[_CTon] != null) {
    contents[_CTon] = expectString(data2[_CTon]);
  }
...
var de_ListMultipartUploadsCommand = async (output, context) => {
  ...
  if (data2.CommonPrefixes === "") {
    ...
    contents[_CP] = de_CommonPrefixList(getArrayIfSingleItem(data2[_CP]), context);
  }
  if (data2[_D] != null) {
  ...
  if (data2[_KM] != null) {
    contents[_KM] = expectString(data2[_KM]);
  }
  if (data2[_MU] != null) {
    contents[_MU] = strictParseInt32(data2[_MU]);
  }
  if (data2[_NKM] != null) {
    contents[_NKM] = expectString(data2[_NKM]);
  }
  if (data2[_NUIM] != null) {
    contents[_NUIM] = expectString(data2[_NUIM]);
  }
  if (data2[_P] != null) {
    contents[_P] = expectString(data2[_P]);
  }
  if (data2[_UIM] != null) {
    contents[_UIM] = expectString(data2[_UIM]);
  }
  if (data2.Upload === "") {
    contents[_Up] = [];
  } else if (data2[_U] != null) {
    contents[_Up] = de_MultipartUploadList(getArrayIfSingleItem(data2[_U]), context);
  }
  return contents;
};
var de_ListObjectsCommand = async (output, context) => {
  ...
  if (data2.Contents === "") {
    ...
    contents[_Co] = de_ObjectList(getArrayIfSingleItem(data2[_Co]), context);
  }
  if (data2[_D] != null) {
    contents[_D] = expectString(data2[_D]);
  }
  ...
  if (data2[_M] != null) {
    contents[_M] = expectString(data2[_M]);
  }
  if (data2[_MK] != null) {
  ...
  if (data2[_NM] != null) {
    contents[_NM] = expectString(data2[_NM]);
  }
  if (data2[_P] != null) {
    contents[_P] = expectString(data2[_P]);
  }
...
var de_ListObjectVersionsCommand = async (output, context) => {
  ...
  if (data2.DeleteMarker === "") {
    contents[_DMe] = [];
  } else if (data2[_DM] != null) {
    contents[_DMe] = de_DeleteMarkers(getArrayIfSingleItem(data2[_DM]), context);
  }
  if (data2[_D] != null) {
    contents[_D] = expectString(data2[_D]);
  }
  ...
  if (data2[_NVIM] != null) {
    contents[_NVIM] = expectString(data2[_NVIM]);
  }
  if (data2[_P] != null) {
    contents[_P] = expectString(data2[_P]);
  }
  if (data2[_VIM] != null) {
    contents[_VIM] = expectString(data2[_VIM]);
  }
  if (data2.Version === "") {
    contents[_Ve] = [];
  } else if (data2[_V] != null) {
    contents[_Ve] = de_ObjectVersionList(getArrayIfSingleItem(data2[_V]), context);
  }
  return contents;
};
var de_ListPartsCommand = async (output, context) => {
  ...
  if (data2[_CA] != null) {
    contents[_CA] = expectString(data2[_CA]);
  }
  if (data2[_CT] != null) {
    contents[_CT] = expectString(data2[_CT]);
  }
  if (data2[_In] != null) {
    contents[_In] = de_Initiator(data2[_In], context);
  }
  if (data2[_IT] != null) {
    contents[_IT] = parseBoolean(data2[_IT]);
  }
  ...
  if (data2[_MP] != null) {
    contents[_MP] = strictParseInt32(data2[_MP]);
  }
  if (data2[_NPNM] != null) {
    contents[_NPNM] = expectString(data2[_NPNM]);
  }
  if (data2[_O] != null) {
    contents[_O] = de_Owner(data2[_O], context);
  }
  if (data2[_PNM] != null) {
    contents[_PNM] = expectString(data2[_PNM]);
  }
  if (data2.Part === "") {
    contents[_Part] = [];
  } else if (data2[_Par] != null) {
    contents[_Part] = de_Parts(getArrayIfSingleItem(data2[_Par]), context);
  }
  if (data2[_SC] != null) {
    contents[_SC] = expectString(data2[_SC]);
  }
...
var de_UploadPartCopyCommand = async (output, context) => {
  ...
  const data2 = expectObject(await parseXmlBody(output.body, context));
  contents.CopyPartResult = de_CopyPartResult(data2, context);
  return contents;
};
...
var de_ContinuationEvent_event = async (output, context) => {
  ...
  Object.assign(contents, de_ContinuationEvent(data2, context));
  return contents;
};
var de_EndEvent_event = async (output, context) => {
  const contents = {};
  const data2 = await parseXmlBody(output.body, context);
  Object.assign(contents, de_EndEvent(data2, context));
  return contents;
};
var de_ProgressEvent_event = async (output, context) => {
  const contents = {};
  const data2 = await parseXmlBody(output.body, context);
  contents.Details = de_Progress(data2, context);
  return contents;
};
...
var de_StatsEvent_event = async (output, context) => {
  const contents = {};
  const data2 = await parseXmlBody(output.body, context);
  contents.Details = de_Stats(data2, context);
  return contents;
};
